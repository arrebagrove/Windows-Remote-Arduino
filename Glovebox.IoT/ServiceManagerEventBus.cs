...
namespace Glovebox.IoT {
    public class ServiceManagerEventBus : IServiceManager {
        ...
        const string ServicebusNamespace = ConfigurationManager.ServicebusNamespace;
        const string EventHubName = ConfigurationManager.EventHubName;
        string DeviceName = ConfigurationManager.DeviceId;
        const string KeyName = ConfigurationManager.KeyName;
        const string Key = ConfigurationManager.Key;
